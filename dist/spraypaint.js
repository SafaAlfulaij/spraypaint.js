(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.spraypaint = {}));
    ...
    ***************************************************************************** */
    ...
    var IDMap = /** @class */ (function () {
        ...
        IDMap.prototype.create = function (model, key) {
            model.storeKey = key;
            model.stale = false;
            this.data[key] = lodash.cloneDeep(model.attributes);
        };
        IDMap.prototype.updateOrCreate = function (model) {
            ...
            eventbus_min.dispatch(model.storeKey, {}, this.data[model.storeKey]);
        };
    ...
    var DirtyChecker = /** @class */ (function () {
        ...
        DirtyChecker.prototype._hasDirtyAttributes = function () {
            return !lodash.isEmpty(this.dirtyAttributes());
        };
    ...
    var Scope = /** @class */ (function () {
        ...
        Scope.prototype.copy = function () {
            var newScope = lodash.cloneDeep(this);
            return newScope;
        };
        // private
    ...
    var SpraypaintBase = /** @class */ (function () {
        ...
        SpraypaintBase.inherited = function (subclass) {
            ...
            subclass.attributeList = lodash.cloneDeep(subclass.attributeList);
            subclass.linkList = lodash.cloneDeep(subclass.linkList);
        };
        ...
        SpraypaintBase.prototype.unlisten = function () {
            ...
            if (!this.klass.sync)
                return;
            if (this.storeKey) {
                eventbus_min.removeEventListener(this.storeKey, this.onStoreChange());
                eventbus_min.removeEventListener(this.storeKey + "-sync-relationships", this.onSyncRelationships());
            }
        ...
        SpraypaintBase.prototype.listen = function () {
            ...
            if (!this._onStoreChange) {
                ...
                eventbus_min.addEventListener(this.storeKey, this.onStoreChange());
                eventbus_min.addEventListener(this.storeKey + "-sync-relationships", this.onSyncRelationships());
            }
        };
        SpraypaintBase.prototype.syncRelationships = function () {
            eventbus_min.dispatch(this.storeKey + "-sync-relationships", {}, this.relationships);
        };
        ...
        SpraypaintBase.prototype.rollback = function () {
            this._attributes = lodash.cloneDeep(this._originalAttributes);
        };
        ...
        SpraypaintBase.url = function (id, extra) {
            var endpoint = this.endpoint || "" + this.jsonapiType;
            var parts = [this.fullBasePath(), endpoint];
            if (id) {
                parts.push(id);
            }
            if (extra) {
        ...
        SpraypaintBase.prototype.destroy = function () {
            return __awaiter(this, void 0, void 0, function () {
                var url, request, response, err_1, base;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        HasMany.prototype.getter = function (context) {
            ...
            while (index--) {
                if (wasDestroyed(gotten[index])) {
                    context.relationships[this.name];
